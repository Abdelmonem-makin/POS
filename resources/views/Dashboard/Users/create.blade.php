 ...
 <div class="card  ">
            <div class="card-header py-0">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a class="py-0 text-dark nav-link" href="{{ route('dashboard.index') }}"><i class="fa fa-home" aria-hidden="true"></i> الرئيسيه </a></li> <
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 p-0">
                            ...
                            <ul class="nav p-0 nav-tabs" id="myTab" role="tablist">
                                ...
                                @endphp
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{$index == 0?'active':''}} " id="home-tab{{$index}}" data-bs-toggle="tab" data-bs-target="#home{{$index}}" type="button" role="tab" aria-controls="home{{$index}}" aria-selected="{{$index == 1?'true':'fales'}}">
                            ...
                            <div class="tab-content pe-2">
                                ...
                                @foreach ($permitions as  $index => $permition)
                                    <div   class="tab-pane {{$index == 0 ? 'active':''}}  " id="home{{$index}}" role="tabpanel" aria-labelledby="home-tab{{$index}}">
                                        ...
                                        @foreach ($Roles as  $Role)
                                                    ...
                                                    <div class="col-3  p-0  ">
                                                        <div class="form-check p-0 ">
                                                            <label style="    font-size: 13px;" class="form-check-label" for=""><input class="form-check-input" name='permissions[]'type="checkbox" value="{{$permition.'_'.$Role}}"id=""/> {{__('trans.'.$Role)}} {{__('trans.'.$permition)}} </label>
                                                        </div>
                                                    </div>
