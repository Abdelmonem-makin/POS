...
@section('content')
    ...
    @endif
    <form action="{{ route('empExpenses') }}" method="POST" class="p-4 border w-50 m-auto rounded shadow-sm bg-light">
        @csrf
        <h2 class="form-label">المصروفات اليوميه</h2>
        ...
        <a href="{{ route('Home') }}" class="btn btn-success" style='text-align:right;' class="dropdown-item">  رجوع
        </a>
    </form>
@endsection
