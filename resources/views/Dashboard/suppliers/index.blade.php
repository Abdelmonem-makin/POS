            ...
            <div class="card">
                <div class="card-header py-0">
                    ...
                    <div class="d-flex justify-content-between">
                        <h3 class=" my-2 me-a"> الموردين </h3>
                        <form class="row g-3 h-25 mt-1  needs-validation" action="{{ route('supplier.index') }}"
                            method="get">
                            ...
                            <div class="col-md-6 m-0">
                                ...
                                @if (auth()->user()->hasPermission('supplier_create'))
                                    <a class="btn btn-primary my-0 ms-a"href="{{ route('supplier.create') }}">اضافة منتج</a>
                                @else
                                    <a class="btn btn-primary my-0 disabled ms-a"href="{{ route('supplier.create') }}">اضافة
                                        منتج</a>
                                @endif
                        ...
                        <ol class="breadcrumb my-2">
                            ...
                            < <li class="active mx-2"> الموردين </a></li>
                        </ol>
                    </div>
                ...
                <div class="card-body">
                                    ...
                                    @isset($suppliers)
                                        @foreach ($suppliers as $index => $supplier)
                                            <tr>
                                                ...
                                                <th scope="row">{{ $supplier->compane_name }}</th>
                                                <th scope="row">{{ $supplier->address }}</th>
                                                <th scope="row">{{ $supplier->phone }}</th>
                    ...
                    {!! $suppliers->appends(request()->search)->links() !!}
                </div><!-- bd -->
            </div><!-- bd -->
        </div>
        <!--/div-->
