    ...
    <div class="card  ">
        <div class="card-header ">
            ...
            <div class="d-flex justify-content-start">
                ...
                <a href="{{ route('supplier.index') }}" class=" nav nav-link me-a">الورديه  </a>
                <h3 class="  me-a">-</h3>
                <p class="nav  text-dark nav-link me-a">اضافة ورديه  </p>
        ...
        <div class="card-body w-75 mt-auto">
            ...
            @endif
            <form method="POST" action="{{ route('Shift.store') }}" id="selectForm2">
                @csrf
                <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    <select id="name" class="form-control @error('name') is-invalid @enderror" name="name">
                                        ...
                                        <option value="صباحيه">صباحيه</option>
                                        <option value="مسائيه">مسائيه</option>
                                    </select>
                                    @error('name')
