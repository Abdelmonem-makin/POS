...
@section('content')
    <div class="card  ">
        ...
        <div class="card-body w-75 mt-auto">
            ...
            @endif
            <form method="POST" action="{{ route('Product.update', ['Product' => $editID->id]) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ $editID->name }}" autocomplete="name" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <select class="form-select form-select-md @error('categories_id') is-invalid @enderror"
                                name="categories_id" id="categories_id" data-placeholder=" اختار القسم ....."
                                style="width:100%">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="price" value="{{ $editID->price }}" type="number"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="sell_price" type="number" value="{{ $editID->sell_price }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check  form-switch ">
                            <input class=" form-check-input  @error('status') is-invalid @enderror" value="1"
                                name="status" type="checkbox" @if ($editID->status == 1) checked @endif>
                            @error('status')
                                <span class="text-danger">{{ $message }}*</span>
                            @enderror
                        </div>
