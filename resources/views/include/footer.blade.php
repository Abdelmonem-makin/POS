                                ...
                                <div class="wrap-list-item apps-list">
                                    <ul>
                                        <li><a href="#" class="link-to-item"
                                                ...
                                                <figure><img src="{{ asset('images/brand/apple-store.png') }}"
                                                        alt="apple store" width="128" height="36"></figure>
                                            </a></li>
                                        <li><a href="#" class="link-to-item"
                                                title="our application on google play store">
                                                <figure><img src="{{ asset('images/brand/google-play-store.png') }}"
            ...
            <div class="container">
                ...
                <div class="coppy-right-item item-right">
                    <div class="wrap-nav horizontal-nav ">
                        <ul>
                            <li class="menu-item "><a href="about-us.html " class=" text-white link-term">About
                                    us</a></li>
                            <li class="menu-item"><a href="privacy-policy.html" class=" text-white link-term">Privacy
                                    Policy</a></li>
                            <li class="menu-item"><a href="terms-conditions.html" class=" text-white link-term">Terms
                                    &amp; Conditions</a></li>
                            <li class="menu-item"><a href="return-policy.html" class=" text-white link-term">Return
                                    Policy</a></li>
                        </ul>
                    </div>
                </div>
